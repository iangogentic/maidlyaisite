...
${preferences.filter(p => p.active).map(p => `• ${p.label} (${p.category})`).join('\n')}
              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <ul className="text-sm space-y-1 text-muted-foreground">
                    <li>• Mention allergies or sensitivities</li>
                    <li>• Describe your pets and their behavior</li>
                    <li>• Share access instructions or security preferences</li>
                    <li>• Note special care items or areas of focus</li>
                  </ul>
                </CardContent>
              </Card>
            </TabsContent>
            ...
            <TabsContent value="memory" className="space-y-4">
              <Card>
                <CardContent className="pt-6">
                  ...
                  <ul className="text-sm space-y-1 text-muted-foreground">
                    <li>• <strong>Products:</strong> Cleaning supplies, scents, allergies</li>
                    <li>• <strong>Access:</strong> Keys, gates, security systems</li>
                    <li>• <strong>Pets:</strong> Behavior, containment, special needs</li>
                    <li>• <strong>Special:</strong> Delicate items, focus areas</li>
                  </ul>
                </CardContent>
              </Card>
            </TabsContent>
            ...
            <TabsContent value="briefing" className="space-y-4">
              <Card>
                <CardContent className="pt-6">
                  ...
                  <ul className="text-sm space-y-1 text-muted-foreground">
                    <li>• Personalized cleaning protocols</li>
                    <li>• Product and equipment recommendations</li>
                    <li>• Safety and access instructions</li>
                    <li>• Quality checkpoints and focus areas</li>
                  </ul>
                </CardContent>
              </Card>
            </TabsContent>
