...
export function CareerApplicationForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log('Making API request to /api/careers');
    ...
    return (
      ...
      >
        ...
        <p className="text-lg text-muted-foreground mb-6">
          Thank you for your interest in joining Maidly.ai. We'll review your application and get back to you within 48 hours.
        </p>
  ...
  return (
    <Card className="max-w-2xl mx-auto">
      <CardHeader>
        <CardTitle className="text-center">Apply for C-Suite Internship</CardTitle>
        <p className="text-center text-muted-foreground">
          Join Maidly.ai and start your career in the C-suite
        </p>
      </CardHeader>
      <CardContent>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="COO">COO - Chief of Operations</SelectItem>
                    <SelectItem value="CMO">CMO - Chief of Marketing</SelectItem>
                    <SelectItem value="CTO/AI">CTO/AI - Chief of Technology</SelectItem>
                    <SelectItem value="CFO">CFO - Chief of Finance</SelectItem>
                  </SelectContent>
                </Select>
          ...
          <div className="space-y-4">
            ...
            <div>
              <label htmlFor="why_interested" className="block text-sm font-medium text-foreground mb-2">
                Why are you interested in this role at Maidly.ai?
              </label>
              <Textarea
                id="why_interested"
